...
public class Polifase{
	...
	public static int llaves = 2;

	/**
	* Constructor particular de la clase.
	* @param archivoEntrada Nombre del archivo ubicado en el escritorio.
	* @param llaves Numero de llaves iniciales a leer en el archivo.
	*/
	public Polifase(String archivoEntrada, int llaves){
