...
lectura();}}
     public void lectura() {
		...
		try{
			FileInputStream archivo = new FileInputStream("/Users/LMRF/Desktop/equilibrada/src/equilibrada/Texto.txt");// creacion del flujo de lectura
         ...
         void ordena(){
           try{
			PrintWriter wf = new PrintWriter("/Users/LMRF/Desktop/equilibrada/src/equilibrada/Texto.txt");
         ...
         boolean ordenado(){
            boolean orden=false;
                            String lec="";
                int lec2=0,temp,temp2=0,i;
            try{
			FileInputStream archivo = new FileInputStream("/Users/LMRF/Desktop/equilibrada/src/equilibrada/Texto.txt");	
                        BufferedReader br = new BufferedReader(new InputStreamReader(archivo));
                        while(lec2!=-1&&orden==false){
                        i=1000000;
                        temp=0;
                        lec2=br.read();
                        while(lec2!=coma&&lec2!=-1){
                        temp=temp+lec2*i;
                        lec=lec+(char)lec2;
                        lec2=br.read();
                        i=i/1000;
                        ...
                        if(temp<temp2){//en caso de que continue en orden el numero se agrega a la lista y se actualiza el valor anterior
                        orden=true;
                        }
                        temp2=temp;
                        lec="";
