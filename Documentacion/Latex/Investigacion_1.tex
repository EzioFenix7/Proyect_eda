...
\begin{document}
	...
	con las mismas características, cada uno implica un costo distinto ya sea en cuanto a la eficiencia en rapidez (¿quién ordena más rápido?), y/o a
	...
	por completo desde la memoria principal
	...
	Internamente puede llegar a ser ineficiente debido a que las claves leidas las ordena mediante el método de \textit{BubbleSort}. Su ejecución se pudo realizar satisfactoriamente en los sistemas operativos
	Windows y MacOS.\\
